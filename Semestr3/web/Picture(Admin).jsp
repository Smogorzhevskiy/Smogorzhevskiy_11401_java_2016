...
<table border="1" width="303">
    ...
    <tr>
        <td width="100"><img width="100" height="100" src=<%=p%> >
            <%=author%></td>
        <td width="1000"><%=itr.next()%></td>
        <form action="/DeleteComment" method="post">
        <td width="100"><input type="submit" name="delete" value="delete"><input type="hidden" name="author" value="<%=itr.next()%>">
            <input type="hidden" name="id" value=<%=request.getAttribute("id")%>></td>
        </form>
    </tr>
    <%}%>
</table>
