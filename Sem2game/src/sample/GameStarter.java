...
public class GameStarter extends Application {
    ...
    private class Tile extends StackPane {
        ...
        public Tile() {
            ...
            final ScaleTransition animationGrow = new ScaleTransition(Duration.millis(DURATION), text);
            animationGrow.setToX(SCALE);
            animationGrow.setToY(SCALE);

            // и уменьшения
            final ScaleTransition animationShrink = new ScaleTransition(Duration.millis(DURATION), text);
